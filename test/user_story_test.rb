...
describe 'user stories' do
  ...
  describe 'wave 1' do
    ...
    it 'I want exception raised when an invalid date range is provided, so that I cant make a reservation for an invalid date range' do
      expect{BookingDates.new(start_date: nil, end_date: nil)}.must_raise StandardError
  ...
  describe 'wave 3' do
    it 'I can create a Hotel Block if I give a date range, collection of rooms, and a discounted room rate' do
      hotel.add_rooms(num_rooms: 20, cost: 200)
      new_room_block = reservation_booker.book_roomblock(num_rooms: 5, booking_date_range: new_booking_dates , discount:  20)
